...
function buildAlisState(partial: Partial<AlisPageProps>): AlisPageProps {
  return {
    ...
    workspace: {
      ...
      bank_info: {},
      payment_method: 'bank',
      market_rates: { eur_dkk_fx: '', gold_rates_eur: {}, silver_rates_eur: {}, gold_24k_dkk: '', silver_dkk: '', gold_matrix: [], silver_matrix: [] },
    ...
    candidateCustomers: [],
    newCustomer: { name: '', email: '', phone: '', address: '', postal_code: '', city: '', cpr_number: '', identity_doc_number: '' },
    setNewCustomer: () => undefined,
    onSelectExistingCustomer: () => undefined,
    onCreateNewCustomer: () => undefined,
    customerForm: { name: '', email: '', phone: '', address: '', postal_code: '', city: '', cpr_number: '', identity_doc_number: '' },
    ...
    marketRates: { eur_dkk_fx: '', gold_rates_eur: {}, silver_rates_eur: {}, gold_24k_dkk: '', silver_dkk: '', gold_matrix: [], silver_matrix: [] },
