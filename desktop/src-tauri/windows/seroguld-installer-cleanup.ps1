...
function Preserve-LegacyRuntimeSettings {
  ...
  $allowedKeys = @(
    ...
    "KDS_ADDRESS_CACHE_SECONDS", "OPENAI_API_KEY", "OPENAI_BASE_URL", "OPENAI_MODEL", "OPENAI_MAX_TOKENS",
    ...
    "POS_REFERENCE_SCAN_WINDOW", "MARKET_RATES_LIVE_ENABLED", "GOLD_PRICE_LIVE_ENABLED", "GOLD_PRICE_TIMEOUT_SECONDS", "GOLD_PRICE_CACHE_SECONDS",
