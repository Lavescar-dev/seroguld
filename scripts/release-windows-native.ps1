...
function Get-CustomerRuntimeSeedAllowedKeys {
  return @(
    ...
    "INVOICE_SELLER_CVR", "INVOICE_SELLER_EMAIL", "INVOICE_SELLER_PHONE", "POS_REFERENCE_START", "POS_REFERENCE_SCAN_WINDOW",
    "MARKET_RATES_LIVE_ENABLED", "GOLD_PRICE_LIVE_ENABLED", "GOLD_PRICE_TIMEOUT_SECONDS", "GOLD_PRICE_CACHE_SECONDS",
